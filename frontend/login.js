  ...
  return (
    <SafeAreaView style={styles.container}>
        ...
        <View style={styles.buttonView}>
            <Pressable style={styles.button} onPress={() => {props.navigation.navigate("Transition");Alert.alert("Login Successfuly!","see you in my instagram if you have questions : must_ait6")}}>
